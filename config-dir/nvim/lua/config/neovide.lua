...
if vim.g.NEOVIDETRANSPARENCY ~= nil then
	vim.g.neovide_transparency = vim.g.NEOVIDETRANSPARENCY
end
...
vim.keymap.set("n", "<C-+>", function()
	vim.g.neovide_transparency = vim.g.neovide_transparency + 0.025
	if vim.g.neovide_transparency >= 1 then
		vim.g.neovide_transparency = 1
	end
	vim.g.NEOVIDETRANSPARENCY = vim.g.neovide_transparency
	print("Transparency :" .. vim.g.neovide_transparency)
end)
